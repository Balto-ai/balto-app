            ...
            <div className='profile-header'>
              ...
              <div className='profile-title'>
                ...
                <section className='tags'>
                  <span className='tag'>{dogInfo.breed}</span>
                <span className='tag'>{dogInfo.dob}</span>
                <span className='tag'>{dogInfo.size}</span>
                <span className='tag'>{dogInfo.sex === 'm' ? 'male' : 'female'}</span>
                </section>
              </div>
            </div>
